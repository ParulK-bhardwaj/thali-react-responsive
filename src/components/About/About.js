  ...
  function About() {
    return (
      <article className='About text-white bg-gray-950 p-4 sm:p-2'>
        <header>
        ...
        <div className='flex flex-wrap justify-center items-center m-8'>
          <div className="w-full md:w-1/2 py-3">
            <div className='About-image rounded-lg overflow-hidden border sm:h-96'>
              <figure className='About-image sm:h-100'>
                <img src={Thali} alt='Indian-thali'></img>
              </figure>
            </div>
          </div>
          <section className="w-full lg:w-1/2">
            <p className='About-desc rounded-lg text-lg mr-4 sm:m-2' aria-labelledby='about-desc-label'>Welcome to the ultimate guide to Indian cuisine! Our site is dedicated to showcasing the rich and diverse flavors of India, featuring the most popular dishes from each of the 29 states. 
              ...
              We have carefully researched and tasted the d ishes to bring you the most comprehensive information on Indian cuisine. 
